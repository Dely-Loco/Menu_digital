        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 items-end">
          ...
          <div className="lg:col-span-3 xl:col-span-4">
            ...
            <div className="relative">
              <Input id="search" type="text" placeholder="Nombre, marca, catego..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pr-12 w-full h-10 text-sm"/>
              <Button 
                type="submit"
                variant="ghost" 
                size="icon" 
